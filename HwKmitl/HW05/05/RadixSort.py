...
def radixSort(linkedList):
    ...
    for digit in range(1000):
        ...
        while not zeroL.isEmpty():
            linkedList.append(zeroL.pop(0).data)
        while not oneL.isEmpty():
            linkedList.append(oneL.pop(0).data)
        while not twoL.isEmpty():
            linkedList.append(twoL.pop(0).data)
        while not threeL.isEmpty():
            linkedList.append(threeL.pop(0).data)
        while not fourL.isEmpty():
            linkedList.append(fourL.pop(0).data)
        while not fiveL.isEmpty():
            linkedList.append(fiveL.pop(0).data)
        while not sixL.isEmpty():
            linkedList.append(sixL.pop(0).data)
        while not sevenL.isEmpty():
            linkedList.append(sevenL.pop(0).data)
        while not eightL.isEmpty():
            linkedList.append(eightL.pop(0).data)
        while not nightL.isEmpty():
            linkedList.append(nightL.pop(0).data)
